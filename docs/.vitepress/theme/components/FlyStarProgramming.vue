...
onMounted(() => {
  ...
  var $ = c.getContext("2d") as CanvasRenderingContext2D;
  var u = 0;
  ...
  var go = function () {
    ...
    c.height = window.innerHeight - document.getElementsByClassName('VPNav')[0].clientHeight;
  ...
  /* Marsaglia's Xorshift128 PRG:
               http://en.wikipedia.org/wiki/Xorshift */
  var shift = function (x?: any, y?: any, z?: any, w?: any) {
    x = x || 123456789;
    y = y || 362436069;
    z = z || 521288629;
    w = w || 88675123;
